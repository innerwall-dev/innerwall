...
- Surface design rules for estate-scale automation: bulk endpoints, cursor pagination everywhere, async job pattern for expensive operations (mutations that fan out return a job ID, never block).
